...
DefaultDirName={autopf}\Autodesk\ApplicationPlugins\ArkZGames.bundle
DefaultGroupName=ARK-Z\ArkZGames
AllowNoIcons=yes
PrivilegesRequired=admin
OutputDir=.\Output
OutputBaseFilename=ArkZGames_v_{#MyAppVersion}_Setup
...
; ============================================================
Source: ".\Fonts\*"; DestDir: "{autopf}\Autodesk\ApplicationPlugins\ArkZGames.bundle\"; Flags: ignoreversion recursesubdirs
; Source: "README.MD"; DestDir: "{autopf}\Autodesk\ApplicationPlugins\ArkZGames.bundle\"; Flags: ignoreversion recursesubdirs
; Source: "LICENSE"; DestDir: "{autopf}\Autodesk\ApplicationPlugins\ArkZGames.bundle\"; Flags: ignoreversion recursesubdirs
; Source: "Instrucoes.txt"; DestDir: "{autopf}\Autodesk\ApplicationPlugins\ArkZGames.bundle\"; Flags: ignoreversion recursesubdirs

[UninstallDelete]
; ============================================================
; REMOVE TODOS OS ARQUIVOS DO ArkZGames
; ============================================================
...
begin
  ...
  begin
    MsgBox('ATENCAO: Nenhuma versao do AutoCAD foi encontrada neste computador.' + #13#10 +
           'O ArkZ Games requer AutoCAD 2013 ou superior para funcionar.' + #13#10 + #13#10 +
...
// ============================================================
// FUNCAO DE LIMPEZA - REMOVE ARQUIVOS CUIX/MNR DO ArkZGames
// ============================================================
procedure DeleteArkZGamesFiles(const RootPath: string);
var
  FindRec: TFindRec;
  FilePath: string;
  FileName: string;
      ...
      repeat
        ...
        begin
          ...
          if FindRec.Attributes and FILE_ATTRIBUTE_DIRECTORY <> 0 then
            DeleteArkZGamesFiles(FilePath)
          else if (Pos('ArkZGames', FileName) > 0) and   // <<< CORRIGIDO: tudo minúsculo
  ...
  begin
    ...
    begin
      ...
      if DirExists(SupportPath) then
        DeleteArkZGamesFiles(SupportPath);
    end;
  end;
end;