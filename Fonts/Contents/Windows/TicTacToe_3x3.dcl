tictactoe_3x3 : dialog {
    label = "Jogo da Velha 3x3 (Gráfico)";
: row {
	alignment = centered;
	fixed_width = true;
	fixed_height = true;  
...
//
    ...
    : row {
        : image_button { key = "cell_0_0"; width = 5; height = 4;}
        : image_button { key = "cell_0_1"; width = 5; height = 4;}
        : image_button { key = "cell_0_2"; width = 5; height = 4;}
    }
    : row {
        : image_button { key = "cell_1_0"; width = 5; height = 4;}
        : image_button { key = "cell_1_1"; width = 5; height = 4;}
        : image_button { key = "cell_1_2"; width = 5; height = 4;}
    }
    : row {
        : image_button { key = "cell_2_0"; width = 5; height = 4;}
        : image_button { key = "cell_2_1"; width = 5; height = 4;}
        : image_button { key = "cell_2_2"; width = 5; height = 4;}
    }
//
...
// ======================================================================
//	TicTacToe_3x3_Help.dcl
// ======================================================================
TicTacToe_3x3_Help : dialog {
